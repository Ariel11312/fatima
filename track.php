                        ...
                        <div class="order-items">
                                    ...
                                    <div class="product-card">
                                        <div class="product-image-container">
                                            <?php if (!empty($item['product_image'])): ?>
                                                <img src="<?php echo htmlspecialchars($item['product_image']); ?>" alt="<?php echo htmlspecialchars($item['product_name'] ?? 'Product'); ?>" class="product-image">
                                            <?php else: ?>
                                                <img src="./assets/images/product-placeholder.jpg" alt="Product image placeholder" class="product-image">
                                            <?php endif; ?>
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><?php echo htmlspecialchars($item['product_name'] ?? 'Unknown Product'); ?></h4>
                                            <div class="product-code">Product Code: <?php echo htmlspecialchars($item['product_id'] ?? 'N/A'); ?></div>
                                            ...
                                            <div class="product-meta">
                                                ...
                                                <div class="product-subtotal"><?php echo formatPrice(($item['quantity'] ?? 0) * ($item['price'] ?? 0)); ?></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php else: ?>
                                <div class="no-products">
                                    <i class="fas fa-shopping-basket" style="font-size: 48px; color: var(--medium-gray); margin-bottom: 20px;"></i>
